...
export function SurveyComponent() {
    ...
    return (<div className="Main-flex-component">
        ...
        <div className='Survey'>
            <h3>1.Quelle est la période de construction de votre maison ?</h3>
            ...
            <h3>2. Quels travaux avez-vous déja effectués ces 20 derières années (plusieurs réponses possibles) ?</h3>
            <div className='Survey-choice'>
                <button
